...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
        ...
        XXXXXXX,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_MUTE,    XXXXXXX,    KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_QUOT,    MO(3),
                                KC_DQT,     KC_BSLS,    KC_BSPC, LT(2, KC_TAB), KC_LSFT,    KC_SPC,  LT(1,KC_ENT),  KC_ESC,     KC_LBRC,    KC_RBRC
    ),

	[1] = LAYOUT(
        _______,    KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,                              KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     _______,
        _______,    KC_LEFT,    KC_GRV,     KC_ASTR,    KC_PERC,    KC_UP,                              KC_DOWN,    KC_AMPR,    KC_QUES,    KC_QUOT,    KC_RGHT,    _______,
        _______,    KC_CIRC,    KC_EQL,     KC_UNDS,    KC_DLR,     KC_HASH,                            KC_TILD,    KC_COLN,    KC_LPRN,    KC_RPRN,    KC_SCLN,    _______,
        _______,    KC_LT,      KC_PLUS,    KC_MINS,    KC_GT,      KC_AT,      _______,    _______,    KC_EXLM,    KC_PIPE,    KC_LCBR,    KC_RCBR,    KC_SLSH,    _______,
                                _______,    _______,    _______,    KC_TAB,     _______,    _______, LT(1,KC_ENT),  KC_ESC,     _______,    _______
    ),

	[2] = LAYOUT(
        _______,    _______,    _______,    _______,    _______,    _______,                            _______,    _______,    _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    KC_PGUP,    _______,                            _______,    KC_PGDN,    _______,    _______,    _______,    _______,
        _______,    KC_LSFT,    KC_LALT,    KC_LCTL,    KC_HOME,    _______,                            _______,    KC_END,     _______,    _______,    _______,    _______,
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,
                                _______,    _______,    KC_DEL, LT(2, KC_TAB),  _______,    _______,    KC_ENT,     _______,    _______,    _______
    ),
